        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12 mb-12">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/voluntarios" className="text-gray-400 hover:text-white transition-colors text-sm">
                  Seja Voluntário
                </Link>
              </li>
              <li>
        ...
        <div className="pt-8 border-t border-gray-800">
          <div className="flex flex-col-reverse md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex gap-6">
              <a href="https://www.instagram.com/ongrepense?utm_source=ig_web_button_share_sheet&igsh=MWVwaGd2MG85ZGJqcg==" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">
              ...
              <a href="https://www.linkedin.com/company/repense-ong/?viewAsMember=true" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">
